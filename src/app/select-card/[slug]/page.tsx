        ...
        <div className="flex h-[60.5rem] gap-[1.5rem]">
          <div className="flex flex-col">
            <div className="h-[47.7rem] w-[84.9rem]">
              <AutoSizeImage
                src={
                  thumbnailCounseling[worldIndex].thumbnail_image[thumbnailNum]
                }
                full
                objectCover
                rounded="10"
            ...
            <div className="mt-[1.5rem] grid flex-1 grid-cols-4 gap-[1.5rem]">
              {thumbnailCounseling[worldIndex].thumbnail_image.map(
                (image, index) => (
                  <>
                    {thumbnailNum !== index && (
                      <AutoSizeImage
          ...
          <div className="flex h-full max-w-[47.5rem] flex-col rounded-[1rem] bg-181818/75 px-[3rem]">
            <div>
              <CSText size="31" color="white" weight="bold">
                {thumbnailCounseling[worldIndex].title}
              </CSText>
              <CSText
                size="16"
                color="white"
              ...
              >
                {thumbnailCounseling[worldIndex].description}
              </CSText>

              <div className="mt-[1rem]">
                {thumbnailCounseling[worldIndex].tag.map((value, index) => (
                  <div
              ...
              <div className="mt-[2rem] flex items-end gap-[2.3rem]">
                <CSButton
                  ...
                  weight="bold"
                  onClick={() =>
                    thumbnailCounseling[worldIndex].path
                      ? window.open(thumbnailCounseling[worldIndex].path!)
                      : alert('준비중입니다')
                  }
                >
                  입장하기

...
const CounselPage = () => {
  ...
  const {
    ...
    loaderUrl: `${cfWorkerUrl}/Build/Auditorium.loader.js?action=get`,
    dataUrl: `${cfWorkerUrl}/Build/Auditorium.data?action=get`,
    frameworkUrl: `${cfWorkerUrl}/Build/Auditorium.framework.js?action=get`,
    codeUrl: `${cfWorkerUrl}/Build/Auditorium.wasm?action=get`,
  })
